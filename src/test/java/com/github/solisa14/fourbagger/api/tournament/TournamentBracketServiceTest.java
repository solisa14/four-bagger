...
class TournamentBracketServiceTest {
    ...
    void planBracket_whenSingleElimination_delegatesToSingleEliminationGenerator() {
        ...
        TournamentBracketService service = new TournamentBracketService(singleGenerator, doubleGenerator);
    ...
    private static class RecordingDoubleEliminationGenerator extends DoubleEliminationBracketGenerator {
