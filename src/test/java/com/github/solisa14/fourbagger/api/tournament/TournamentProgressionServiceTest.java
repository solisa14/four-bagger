...
class TournamentProgressionServiceTest {
    ...
    @Mock
    private SingleEliminationProgressionHandler singleEliminationProgressionHandler;

    @Mock
    private DoubleEliminationProgressionHandler doubleEliminationProgressionHandler;
    ...
    void applyGameResult_whenSingleEliminationSeriesClinched_dispatchesCompletedMatch() {
        ...
        verify(singleEliminationProgressionHandler).progress(eq(match), eq(match.getTeamOne()), eq(match.getTeamTwo()));
    ...
    void applyGameResult_whenDoubleEliminationSeriesClinched_dispatchesCompletedMatch() {
        ...
        verify(doubleEliminationProgressionHandler).progress(eq(match), eq(match.getTeamOne()), eq(match.getTeamTwo()));
        verify(singleEliminationProgressionHandler, never()).progress(any(), any(), any());
    }
