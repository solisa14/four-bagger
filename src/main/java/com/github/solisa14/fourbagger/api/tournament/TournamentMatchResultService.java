...
public class TournamentMatchResultService {
    ...
    public TournamentMatchDetailResponse submitResult(
        ...
        if (tournament.getStatus() != TournamentStatus.IN_PROGRESS) {
            throw new InvalidTournamentStateException("Cannot submit results unless the tournament is IN_PROGRESS");
        }
        ...
        TournamentTeam winnerTeam =
                request.teamOneScore() > request.teamTwoScore() ? match.getTeamOne() : match.getTeamTwo();
    ...
    private TournamentMatchDetailResponse handleExistingResult(
            TournamentGameResult existing, SubmitTournamentGameResultRequest request, Match match) {
    ...
    private boolean isExactMatch(TournamentGameResult existing, SubmitTournamentGameResultRequest request) {
