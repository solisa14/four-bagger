 ...
 *
 * <p>
 * Thrown during account creation when the requested username is already taken. Results in an HTTP
 * 409 Conflict response to inform the client to choose a different username.
 */
