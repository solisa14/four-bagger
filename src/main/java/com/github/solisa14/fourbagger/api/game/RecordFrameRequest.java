 ...
 */
public record RecordFrameRequest(@NotNull @Min(0) @Max(4) Integer p1BagsIn,
    @NotNull @Min(0) @Max(4) Integer p1BagsOn, @NotNull @Min(0) @Max(4) Integer p2BagsIn,
    @NotNull @Min(0) @Max(4) Integer p2BagsOn, UUID playerOneThrowerId, UUID playerTwoThrowerId) {
   ...
   */
  public RecordFrameRequest(Integer p1BagsIn, Integer p1BagsOn, Integer p2BagsIn,
      Integer p2BagsOn) {
