...
public class TournamentBracketEligibilityPolicy {
    ...
    public BracketEligibility evaluate(Tournament tournament) {
        ...
        return new BracketEligibility(eligible, participantCount, minimum, requiresEven, message);
    }
    ...
    private String eligibilityMessage(int participantCount, int minimum, boolean requiresEven, boolean eligible) {
        if (eligible) {
