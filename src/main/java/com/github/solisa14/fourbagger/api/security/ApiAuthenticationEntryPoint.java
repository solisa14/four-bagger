...
public class ApiAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public void commence(
        ...
        writeErrorResponse(response, HttpStatus.UNAUTHORIZED, "Authentication is required to access this resource");
    }
    ...
    private void writeErrorResponse(HttpServletResponse response, HttpStatus status, String message)
        ...
        objectMapper.writeValue(response.getOutputStream(), new ErrorResponse(Instant.now(), status.value(), message));
    }
}
