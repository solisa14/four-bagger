...
public class ProdSecurityStartupValidator implements InitializingBean {
    ...
    public static final String KNOWN_DEV_JWT_SECRET = "YWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWE=";
    ...
    static void validate(Environment environment) {
        ...
        String allowedOrigins = requirePresent(
        ...
        String jwtSecret = requirePresent(
    ...
    private static void requireMinimumJwtKeyLength(String jwtSecret) {
        ...
        try {
            ...
            throw new IllegalStateException(
                    "Production JWT_SECRET must be valid Base64 encoding at least 256 bits of key material", ex);
        }
    ...
    private static void rejectLocalOrigins(String allowedOrigins) {
        ...
        for (String origin : origins) {
            ...
            if (normalized.contains("localhost")) {
                throw new IllegalStateException("Production app.cors.allowed-origins must not include localhost");
            }
            if (normalized.contains("127.0.0.1")) {
                throw new IllegalStateException("Production app.cors.allowed-origins must not include 127.0.0.1");
            }
        }
    }
