...
public class TournamentMatchOverrideService {
    ...
    public TournamentMatchDetailResponse overrideMatchResult(
            UUID tournamentId, UUID matchId, User currentUser, OverrideTournamentMatchResultRequest request) {
        ...
        progressionService.applyMatchOverride(match, winningTeam, losingTeam, canonicalScores[0], canonicalScores[1]);
    ...
    private void validateDestinationNotLocked(Match destination) {
        ...
        if (destination.getStartedAt() != null
            ...
            throw new InvalidTournamentStateException("Cannot override match after downstream play has started");
        }
    }
