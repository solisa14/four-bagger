 ...
 *
 * <p>
 * Thrown during account creation when the requested email is already taken. Results in an HTTP 409
 * Conflict response to inform the client to choose a different email.
 */
public class EmailAlreadyExistsException extends BusinessException {
  ...
  public EmailAlreadyExistsException(String email) {
    super("An account with this email may already exist.", HttpStatus.CONFLICT);
  }
}
